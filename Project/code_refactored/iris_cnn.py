...
def splitDataFromDatabase():
    ...
    label_onehot = onehotEncodingLabels(label)
...
def getDataFromFusion ():
    '''
    This gets data from the chimeric data (the merged) dataset.
    '''
    '''
    ...
    return train_X,train_label,test_iris_X,test_label,valid_X,valid_label,NuniqueClasses
    '''
    return 0
