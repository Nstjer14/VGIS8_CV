...
import chimeric_iris_face_fusion_net as chimericData
...
'''
train_iris_X,train_face_X, test_iris_X, test_face_X, validation_iris_X, validation_face_X, train_label, test_label, validation_label, number_of_classes = chimericData.splitChimericData()


NuniqueClasses = number_of_classes
