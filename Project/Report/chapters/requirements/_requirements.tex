...
\hl{The following chapters} the specifications and requirements described in this chapter will be used as directives for the work carried out with investigating and designing identity verification systems. The work is done with the aim of investigating how as high an accuracy as possible \todo[inline]{are we promising to much here?} can be achieved under the conditions specified in \autoref{ch:req}. 
