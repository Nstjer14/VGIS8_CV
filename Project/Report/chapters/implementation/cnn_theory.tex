...
As stated in \autoref{ch:projecspec} a face recognition network must be implemented. This is to take advantage of the theoretical accuracy increase from a multimodal system. This is done by making a face recognition network to combine with the iris recognition. 
