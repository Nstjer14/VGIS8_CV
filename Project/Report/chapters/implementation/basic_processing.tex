...
\hline
KNN (k=1)&$0.7$9&$\pm0.06$&$0.91$&$\pm0.04$\\
\hline
LDA&$0.94$&$\pm0.02$&$0.95$&$\pm0.03$\\
\hline
SVM (Linear)&$0.85$&$\pm0.08$&$0.92$&$\pm0.02$\\
\hline
SVM (quadratic)&$0.77$&$\pm0.08$&$0.92$&$\pm0.04$\\
\hline
\end{tabular}
...
\begin{tabular}{|l|c|c|}
\cline{2-3}
\multicolumn{1}{c|}{}&\multicolumn{2}{c|}{Cross Validation Accuracy}\\
\cline{2-3}
\multicolumn{1}{c|}{}&Replicated&\cite{Khan2017a}\\
\hline
KNN (k=1)&0.91&0.951\\
\hline
LDA&0.95&0.9428\\
\hline
SVM (Linear)&0.92&0.9646\\
\hline
SVM (quadratic)&0.92&0.97\\
\hline
\end{tabular}
\caption{Comparison of the Performance of the different classifiers evaluated by five-fold cross validation. MA is for Mean Accuracy, and $\sigma$ is the standard deviation}
\label{tab:fiveFoldClas}
\end{table} 
